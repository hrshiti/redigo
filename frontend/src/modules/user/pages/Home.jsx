...
const Home = () => {
  return (
    <div className="min-h-screen bg-[#F5F5F5] pb-36 max-w-lg mx-auto relative overflow-hidden font-sans no-scrollbar">
      ...
      <div className="absolute bottom-28 left-0 right-0 h-24 opacity-10 pointer-events-none">
